      ...
      <header className="header">
        ...
        <div className="header-actions">
          <div className="social-links">
            <a href="https://github.com/tubitak" target="_blank" rel="noopener noreferrer" className="social-link">
            ...
            <a href="https://linkedin.com/company/tubitak" target="_blank" rel="noopener noreferrer" className="social-link">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="social-icon">
          ...
          >
            ...
            <span style={{ marginLeft: '8px' }}>Favori İlanlar</span>
            {favorites.length > 0 && (
